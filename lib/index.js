(function() {
  (function(factory) {
    if (typeof exports === "object") {
      return module.exports = factory(require("madLib-console"), require("q"), require("madLib-object-utils"), require("madlib-settings"));
    } else if (typeof define === "function" && define.amd) {
      return define(["madLib-console", "q", "madLib-object-utils", "madlib-settings"], factory);
    }
  })(function(console, Q, objectUtils, settings) {
    var CacheModule;
    ...
    return CacheModule = (function() {
      function CacheModule(cacheName, serviceHandler) {
        this.cache = {
          data: {},
          mtime: {},
          name: cacheName
      ...
      CacheModule.prototype.ensureAvailable = function(params) {
        ...
        if ((currentData != null) && ((expirationTime === void 0) || (now.getTime() - currentMTime) < expirationTime)) {
          ...
          this.service.call(params).then(function(data) {
            var newData;
